                ...
                <div className='loginbox'>
                    ...
                    <form action="" className='mt-[90px]'>
                        ...
                        <div className='mt-[60px] flex justify-between items-center'>
                            <p className={`text-white font-semibold text-[32px] leading-[100%] tracking-[-0.05em] text-left ${PublicSans.className} border-b-[3px] border-white`}><a href="/login">login</a></p>

                            <p className={`text-white font-semibold text-[32px] leading-[100%] tracking-[-0.05em] text-left ${PublicSans.className} border-b-[3px] border-white`}><a href="#">Lost your password?</a></p>
                        </div>
                        ...
                        <div className='flex justify-center items-center gap-[45px] flex-col w-full mt-[60px]'>
                            ...
                            <div className='bg-[#323232] flex justify-center items-center h-[100px] rounded-[22px] gap-[30px] w-full' >
                                ...
                                <p className={`${PublicSans.className} font-medium text-[50px] leading-[100%] tracking-[-0.05em] text-center text-[#fff]`}>Login</p>
                            </div>
                            ...
                            <div className='bg-[#323232] flex justify-center items-center h-[100px] rounded-[22px] gap-[30px] w-full'>
                              <span>
                                ...
                                <p className={`${PublicSans.className} font-medium text-[50px] leading-[100%] tracking-[-0.05em] text-center text-[#fff]`}>Lost your password?</p>
                            </div>
