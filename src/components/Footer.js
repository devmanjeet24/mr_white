...
//   return (
//     <footer className=" bg-[linear-gradient(178.16deg,rgba(255,255,255,0.1)_1.45%,rgba(0,0,0,0.1)_98.35%)]">

//       <div className="w-[1440px] mx-auto">

//         <div className="text-white px-[60px] pt-10">
  ...
  return (
    <footer className="bg-[linear-gradient(178.16deg,rgba(255,255,255,0.1)_1.45%,rgba(0,0,0,0.1)_98.35%)]">
        ...
        <div className="text-white px-[60px] pt-10">
          <div className="flex items-start justify-between gap-10 pb-8">
            ...
            <div className="flex justify-between w-[600px]">
              ...
              {/* Navigation */}
              <div className="flex flex-col">
                <h4 className={`text-[#C8A84B] text-[16px] mb-4 relative pl-3 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[3px] before:h-4 before:bg-white ${PublicSans.className}`}>
                  Navigation
                </h4>
                <ul className="flex flex-col gap-[10px]">
                  {navLinks.map((item) => (
                    <li key={item}>
                      <Link
                        href="#"
                        className={`text-[#cccccc] hover:text-white transition-colors text-[14px] ${PublicSans.className}`}
                      >
                        {item}
                      </Link>
                    </li>
                    ...
                    <li key={s.label}>
                      <Link href={s.href} className="flex items-center gap-2 group">
                        <div className="w-[22px] h-[22px] flex items-center justify-center">
                          <Image src={s.src} alt={s.label} width={18} height={18} />
                        </div>
                        <span
                          className={`text-[#cccccc] group-hover:text-white transition-colors text-[14px] ${PublicSans.className}`}
                        >
                          {s.label}
                        </span>
                      </Link>
            ...
            <div className="self-start mt-1 scale-90">
              <Button
                className="flex justify-center items-center"
                title="Contact Us"
                icon="/Home/footer/footerbtn.png"
                href="/contact"
              />
            </div>
      ...
      <div className="w-full bg-[#FFFFFF1A]">
        <div className="max-w-[1440px] mx-auto px-[60px] py-[10px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-[6px]">
            <Link href="#" className="text-[#888888] text-[13px] hover:text-[#ccc]">
              Terms & Conditions
            </Link>
            <span className="text-[#555555] text-[13px]">/</span>
            <Link href="#" className="text-[#888888] text-[13px] hover:text-[#ccc]">
